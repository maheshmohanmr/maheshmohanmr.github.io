...
* Editing a file, I mean, click the respective file, then click the pencil button (right-top), and edit. Once you finish editing, click commit changes at the bottom. (After commiting, the updates to your website shall only happen after few minutes.).
<br>
<hr>
