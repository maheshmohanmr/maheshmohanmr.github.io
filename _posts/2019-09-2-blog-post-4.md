...
<br>2. Fork [this repository](https://github.com/maheshmohanmr/maheshmohanmr.github.io) by clicking the "fork" button in the top right. (If you find it difficult to spot "fork" button, see the Figure below.<br> 
<br>3. Go to the repository's settings (see the Figure below). Rename the repository "[your GitHub username].github.io", which will also be your website's URL. <br>
...
-----
(Note: Always, I mean the root directory (./) as the outer one, i.e., where you can see the folders: \_data, \_drafts, etc )
<br>1. First   
