...
<br>8. There is no restriction to put files in a folder and invoke for publications (e.g., pdfs and images, we put in ./\_files, and ./\_images, respectively). To put, click upload button (right-top) and upload the files. 
