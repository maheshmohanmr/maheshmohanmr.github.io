...
*  Register a GitHub account if you don't have one and confirm your e-mail (required!). Refer [here](https://www.wikihow.com/Create-an-Account-on-GitHub). When you choose an Github username, select it as your desired domain name in mind, i.e., select <q>your GitHub username</q> for [your GitHub username].github.io. <br>
...
* Scroll down the <q>settings page</q> to reach option  <q>Github Pages<\q> and enable the same. 
<br>
