...
problem from first principles and in developing its inverse model; taking into account ill-posedness (if present) via regularization theory, and other computational considerations, such as convexity property and convergence.   
              </p>
                          </td>
          </tr> 
</tbody> 
