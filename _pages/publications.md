     ...
     <table style="width:100%;border:0px;border-spacing:0px;border-collapse:collapse;margin-right:auto;margin-left:auto;"><tbody>
         ...
         <table style="width:100%;border: 0px solid black;;border-spacing:0px;border-collapse:collapse;margin-right:auto;margin-left:auto;"><tbody>
          ...
          <tr onmouseout="indoml2024_stop()" onmouseover="indoml2024_start()">
            <td style="padding:20px;width:29%;vertical-align:middle;border:0px;border-bottom: 1px solid #ddd;">
              <div class="one">
                <div class="two" id='indoml2024_image'><img src='../files/Indoml2024_img2_ons.JPG'></div>
                <img src='../files/Indoml2024_img1_ons.JPG'>
              </div>
              <script type="text/javascript">
          ...
          <tr onmouseout="CA2022_stop()" onmouseover="CA2022_start()">
            <td style="padding:20px;width:38%;vertical-align:middle;border:0px;border-bottom: 1px solid #ddd;">
              <div class="one">
                <div class="two" id='CA2022_image'><img src='../images/CompAgr22_ipn_ons.PNG'></div>
                <img src='../images/CompAgr22_ipn_ons.PNG'>
              </div>
              <script type="text/javascript">
            ...
            <td style="padding:20px;width:71%;vertical-align:middle;border:0px;border-bottom: 1px solid #ddd;">
              ...
              <br>
              <em>Computers and Electronics in Agriculture</em>, 2022 <span style="background-color: #ffd700;">(SJR-Q1)</span>
          ...
          <tr onmouseout="SPL2022_stop()" onmouseover="SPL2022_start()">
            ...
            <td style="padding:20px;width:71%;vertical-align:middle;border:0px;border-bottom: 1px solid #ddd;">
              ...
              <br>
              <em>IEEE Signal Processing Letters</em>, 2022 <span style="background-color: #ffd700;">(SJR-Q1)</span>
          ...
          <tr onmouseout="tip_stop()" onmouseover="tip_start()">
            ...
            <td style="padding:20px;width:71%;vertical-align:middle;border:0px;border-bottom: 1px solid #ddd;">
              ...
              <a href="http://www.ee.iitm.ac.in/~raju/">A. N. Rajagopalan </a>
              <br>
              <em>IEEE Transactions on Image Processing  </em>, 2021 <span style="background-color: #ffd700;">(SJR-Q1)</span>
          ...
          <tr onmouseout="font_stop()" onmouseover="font_start()">
            ...
            <td style="padding:20px;width:71%;vertical-align:middle;border:0px;border-bottom: 1px solid #ddd;">
              ...
              <a href="http://www.ee.iitm.ac.in/~raju/">A. N. Rajagopalan </a>
              <br>
              <em>ICCV</em>, 2019 <span style="background-color: #ffd700;">(CORE-A*; Oral Presentation)</span> 
          ...
          <tr onmouseout="divide_stop()" onmouseover="divide_start()">
            ...
            <td style="padding:20px;width:71%;vertical-align:middle;border:0px;border-bottom: 1px solid #ddd;">
              ...
              <a href="http://www.ee.iitm.ac.in/~raju/">A. N. Rajagopalan </a>
              <br>
               <em>CVPR</em>, 2018   <span style="background-color: #ffd700;">(CORE-A*)</span> 
              <br>
 ...
 <em>CVPR</em>, 2018 <span style="background-color: #ffd700;">(CORE-A*)</span> 
        ...
        <tr onmouseout="RS_stop()" onmouseover="RS_start()">
            ...
            <td style="padding:20px;width:71%;vertical-align:middle;border:0px;border-bottom: 1px solid #ddd;">
              ...
              <br>
               <em>ICCV</em>, 2017 <span style="background-color: #ffd700;">(CORE-A*)</span> 
<br>
          ...
          <tr onmouseout="dynamic_stop()" onmouseover="dynamic_start()">
            ...
            <td style="padding:20px;width:71%;vertical-align:middle;border:0px;border-bottom: 1px solid #ddd;">
              ...
              <a href="http://www.ee.iitm.ac.in/~raju/">A. N. Rajagopalan </a>
              <br>
               <em>ECCV</em>, 2016 <span style="background-color: #ffd700;">(CORE-A*)</span> 
              <br>
...
non-commercial research and education purposes only. Copyrights of the 
papers usually belong to the publishers of the journals or proceedings and 
must be adhered to by anyone using these materials. For other materials, feel free to use it at your convenience for good deeds! <a href="https://drive.google.com/drive/folders/1mtVGg6O-oKwRMBY5ZzSWQ4snNJrGiRlN?usp=sharing">&#8482;</a> <br>
