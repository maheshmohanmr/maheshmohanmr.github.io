    ...
    <table style="width:100%;border:0px;border-spacing:0px;border-collapse:collapse;margin-right:auto;margin-left:auto;"><tbody>
            ...
            <td style="padding:20px;border:0px;border-bottom: 1px solid #ddd;width:100%;vertical-align:middle">
             ...
             1. Amara Datta (Mathematics and Computing, IIT-KGP): Works on Mathematical Foundations of Complex-valued AI (for Image Restoration Problems).    
              ...
              <p>
                Regarding internships, I see it as an integration of classroom knowledge and theory one studied in their first few years with practical application and skills. For the same reason, sorry that I may not be able to accommodate first/second year UGs.
              </p>   
            </td>
          </tr> 
</tbody>
